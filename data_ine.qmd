...
Población municipal obtenidos del Censo anual de población publicado en el INE. Datos para todos los municipios de España desde 2021 a 2024. Población total y por sexo.

```{r}
pop_data <- read_delim(raw_data_file("68065.csv.xz"), delim = ";",
                       locale = locale(decimal_mark = ",",
                                       grouping_mark = "."),
                       col_types = "_ccin",
...
Población de 15 años o más por estudios completados, tramo de edad y sexo. Datos para todos los municipios de España de 500 habitantes o más desde 2021 a 2023.
...
educ_data <- read_ine_csv(raw_data_file("66620.csv.xz")) |>
  ...
  select(-(1:4)) |> 
  filter(age == "age_all", sex == "sex_all") |> 
  group_by(mun_code, year, educ) |> 
